...
{
	//register the widget
	wp_register_sidebar_widget("anchors-widget", "Anchors Menu", "anc_widget_insert");
	//register the widget control
	wp_register_widget_control("anchors-control", "Anchors Menu", "anc_widget_insert_control");   
}
